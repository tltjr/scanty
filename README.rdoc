...
the navigation links at the top of the blog. The links are optional and can be
toggled off by setting :main_nav => false. If they are on, change the name fields
to what you would like displayed on your blog and the links to where you want to 
direct users. See the comments within the struct and http://thomasthornton.heroku.com/
for an example.
