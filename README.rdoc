...
the navigation links at the top of the blog. The links are option and can be
toggled off by setting :main_nav => false. If they are on, change the name fields
to what you would like displayed on your blog and the links to whre you want to 
